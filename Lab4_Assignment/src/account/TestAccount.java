/**
 * Harshita Agarwal
 * assigning a vlue in the constriuctor class
 */
package account;
...
public class TestAccount {
	public static void main(String[] args) {
		...
		/**
		 * Creating smith savings account. Testing savings account class.
		 */
		...
		/**
		 * Creating current account for Kathy. Testing current account class.
		 */
