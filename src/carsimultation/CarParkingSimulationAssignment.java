		...
		do {
			...
			switch(choice) {
				case 1:
					...
					/**
					 * check the parking is available or not
					 */
				...
				case 2:
					/**
					 * find the car detail using registration number
					 */
					...
					/**
					 * check the registration number is found or not. If found then display detail
					 */
					if(carSearched==null) {
				...
				case 3:
					/**
					 * check parking space is avilable or not
					 */
